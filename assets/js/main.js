...
// ---------------------------------------------------------------------------
// Newsletter subscribe popup - the Typeform embed is only mounted into the
// modal the first time it's opened, so visitors who never click the button
// never pay for the extra embed.js request.
// ---------------------------------------------------------------------------

(function () {
  var popupBtn = document.getElementById("newsletter-popup-btn");
  var overlay = document.getElementById("newsletter-modal-overlay");
  var closeBtn = document.getElementById("newsletter-modal-close");
  var modalBody = document.getElementById("newsletter-modal-body");
  if (!popupBtn || !overlay || !closeBtn || !modalBody) return;
  ...
  function mountForm() {
    ...
    embedDiv.setAttribute("data-tf-live", "01KZAMHRP7TNX59ZZ7J2GXR8E1");
